...
export default function GmMessage({ data }: { data: GmMessageProps }) {
  ...
  return (
    <section className="pb-12 md:pb-20 xl:pb-[135px]">
      <div className="container mx-auto flex flex-col xl:flex-row items-center justify-between gap-12 xl:gap-[91px]">
        {/* Left Column */}
        <div className="w-full xl:max-w-[54%]">
          <h2 className="text-4xl leading-[1.1111] font-light text-black mb-[30px] xl:mb-[50px]">
            {" "}
            {title.split("\n").map((line, idx) => (
          ...
          <div className="text-colorpara font-light text-sm leading-[1.526] space-y-7">
            {intro.split("\n").map(
              (line, idx) =>
                line.trim() && (
        ...
        {/* Right Column */}
        <div className="relative w-full max-w-[616px] xl:h-[906px] xl:w-[616px] bg-white">
          ...
          <div className="relative xl:hidden w-full h-[540px] xl:h-full rounded-[12px] overflow-hidden bg-[#F6F6F6]">
            ...
            <Image
              ...
              height={540}
              width={616}
              className="xl:object-cover h-[540px] z-0 rounded-[12px]"
            />
      ...
      <div className="container mt-[50px] text-colorpara font-light text-sm leading-[1.526] space-y-7">
        {description.split("\n").map(
          (line, idx) =>
            line.trim() && (
              <p key={idx} className="whitespace-pre-line">
