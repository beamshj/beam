...
const SchoolFormPage = ({ editMode }: { editMode?: boolean }) => {
    ...
    return (
        <form onSubmit={handleSubmit(handleAddSchool)} className="w-full grid grid-cols-2 gap-10">
            {/* English Version */}
            <div className="flex flex-col gap-5" onSubmit={handleSubmit(handleAddSchool)}>
                <AdminItemContainer>
                    ...
                    <div className="p-5 rounded-md flex flex-col gap-2">
                        <div className="flex flex-col gap-2">
                            <div className="flex flex-col gap-1">
                                ...
                                {errors.title_ar && <p className="text-red-500">{errors.title_ar.message}</p>}
                            </div>
                            <div className="flex flex-col gap-2">
                                ...
                                <Controller
                                    ...
                                    render={({ field }) => (
                                        <Select disabled onValueChange={field.onChange} value={field.value} defaultValue="">
                                            ...
                                            <SelectContent>
                                                {locationList.map((item, index) => (
                                                    <SelectItem key={index} value={item._id} className="w-full">
                                                        {item.name_ar?.trim() ? `${item.name_ar} (${item.name})` : `-`}
                                                    </SelectItem>
                                                ))}
                                            </SelectContent>
                                        </Select>
                            ...
                            <div className="flex flex-col gap-1">
                                <Label className="font-bold">Address</Label>
                                <Input type="text" placeholder="Address" {...register("address_ar")} />
                                {errors.address_ar && <p className="text-red-500">{errors.address_ar.message}</p>}
                            </div>
                        </div>
                        <div className="flex flex-col gap-2">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                />
                                {errors.logo_ar && <p className="text-red-500">{errors.logo_ar.message}</p>}
                                <Label className="font-bold">Logo Alt Tag</Label>
                                <Input type="text" placeholder="Alt Tag" {...register("logoAlt_ar")} />
                            </div>
                        </div>
                        <div className="flex flex-col gap-1">
                            <Label className="font-bold">Link</Label>
                            <Input type="text" placeholder="Link" {...register("link_ar")} />
                            {errors.link_ar && <p className="text-red-500">{errors.link_ar.message}</p>}
                        </div>
                        <div>
                            <Label className="font-bold">Items</Label>
                            <div className="border p-2 rounded-md gap-5 grid grid-cols-3">
                                            ...
                                            <div className="flex gap-2">
                                                <div className="flex flex-col gap-2">
                                                    ...
                                                    {errors.specifications?.[index]?.number_ar && (
                                                        <p className="text-red-500">
                                                            {errors.specifications?.[index]?.number_ar.message}
                                                        </p>
                                                    )}
                                                </div>
                                                <div className="flex flex-col gap-2">
