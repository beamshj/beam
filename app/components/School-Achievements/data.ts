export const BannerData = {
  BannerTitle: "School Achievements",
  BannerImg: "/images/school-achievements/banner.jpg",
};
...
export const achievementsData = {
  ...
  subtitle:
    "Creative Science Schools go beyond academics by equipping students with future-ready skills and supporting families through workshops, programs, and a strong values-based community.",
  achievements: [
    {
      id: 1,
