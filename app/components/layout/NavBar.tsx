          ...
          <div className="flex flex-col flex-1 overflow-y-auto">
            ...
            <div className="mt-auto">
              ...
              <div className="flex gap-[7px] p-6">
                <div className="rounded-full xl:w-[46px] xl:h-[46px] w-[36px] h-[36px] border border-black/35 hover:border-transparent flex items-center justify-center hover:bg-primary cursor-pointer transition-colors duration-300">
