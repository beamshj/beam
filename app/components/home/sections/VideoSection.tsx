...
const VideoSection = () => {
  return (
    <section className='w-full relative h-[950px]'>
        <Image src="/assets/home/video-poster.jpg" alt="Video" width={1920} height={950} className='w-full h-full object-cover absolute z-10'/>
