    ...
    <section className="container py-10 lg:py-15 xl:py-[135px]">
      <div className="flex flex-col lg:flex-row gap-5 lg:gap-10 xl:gap-20 2xl:gap-[103px]">
        ...
        <div className="lg:w-[34%]">
          <h1 className="text-lg lg:text-xl xl:text-3xl 2xl:text-4xl text-black font-light leading-[1.111] lettersp-4"> 
           <SplitText
             tag="span"
             text="Get In Touch"
             delay={100}
          ...
          <motion.p variants={moveUp(0.2)} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} className="text-colorpara text-sm leading-[1.52] mt-[13px]">
            Together, we can manage smarter and learn further.
          </motion.p>
          <div className="mt-[13px] text-sm leading-[1.52] font-light">
            <motion.h2 variants={moveUp(0.3)} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} className="text-primary text-md lg:text-lg xl:text-xl leading-[1.2]">BEAM</motion.h2>
            <motion.p variants={moveUp(0.4)} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} className="text-colorpara mt-[17px]">
          ...
          <motion.div variants={moveUp(0.7)} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} className="mt-[17px] w-full max-h-[287px] 2xl:max-w-[453px] rounded-[12px] overflow-hidden">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="lg:w-[68%] lg:space-y-12" >
          ...
          <motion.div variants={moveUp(0.5)} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} className="relative w-full">
            <select
              {...register("purpose")}
          ...
          <motion.div variants={moveUp(0.7)} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} className="relative inline-block rounded-[50px] p-[1px] bg-gradient-to-r from-[#42BADC] to-[#12586C] mt-5 2xl:mt-0">
            <button type="submit" className="group flex items-center justify-center gap-[10px] px-[20px] py-[11px] w-full h-full text-black bg-white rounded-[50px] text-xs font-light overflow-hidden"
            >
              SEND MESSAGE
              {/* Arrow circle */}
