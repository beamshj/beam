    ...
    <section className="pt-10 xl:pt-20 2xl:pt-[135px]">
      <div className="container">
        ...
        <div className="relative rounded-[12px] overflow-hidden">
          ...
          2xl:left-[60px] 2xl:bottom-[50px] text-white text-md md:text-lg  xl:max--w-0 xl:text-2xl 2xl:text-4xl font-light lettersp-4 leading-[1.111111111] ${isArabic ? "max-w-6xl" : "max-w-[20ch]"}`} >
