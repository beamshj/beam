                ...
                <form onSubmit={handleSubmit(onSubmit)} onFocus={() => setLoadCaptcha(true)} className="lg:w-[68%] lg:space-y-12">
                    ...
                    <div className="flex flex-col lg:flex-row lg:gap-[54px]">
                        ...
                        >
                            <input
                                type="text"
                                placeholder={isArabic ? "رقم الجوال" : "Enter Your Phone Number"}
                                {...register("phone")}
                                onInput={(e) => {
                    ...
                    >
                        ...
                        {errors.purpose && (
                            <p className="text-red-500 text-xs font-light pt-1 min-h-[20px]">{errors.purpose.message}</p>
                        )}
                    </motion.div>
                    ...
                    >
                        <textarea
                            rows={4}
                            placeholder={isArabic ? "أخبرنا المزيد" : "Tell us more"}
                            {...register("message")}
                        ...
                        />
                        {errors.message && (
                            <p className="text-red-500 text-xs font-light pt-1 min-h-[20px]">{errors.message.message}</p>
                        )}
                    </motion.div>
                    <div>
                        {loadCaptcha && (
                        ...
                        <motion.div
                            ...
                            whileInView="show"
                            viewport={{ once: true, amount: 0.2 }}
                            className="relative inline-block rounded-[50px] p-[1px] bg-gradient-to-r from-[#42BADC] to-[#12586C] mt-5"
                        >
                            <button
                                type="submit"
