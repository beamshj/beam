      ...
      <div className="container">
        ...
        <div className="flex justify-between pl-5">
          ...
          <motion.div variants={moveUp(0.2)} initial="hidden" whileInView="show" viewport={{amount: 0.1, once: true}}>
            <Image src="/images/newsdetails/share.svg" alt="" width={19} height={22} />
          </motion.div>
        </div>
        <motion.div variants={moveUp(0.2)} initial="hidden" whileInView="show" viewport={{amount: 0.1, once: true}} className="py-4 md:py-6 xl:py-8 2xl:py-12">
          <Image src="/images/newsdetails/banner.jpg" alt="" width={1360} height={535} className="rounded-sm" />
        </motion.div>
        <div>
          <motion.p variants={moveUp(0.2)} initial="hidden" whileInView="show" viewport={{amount: 0.1, once: true}} className="text-colorpara text-sm font-light">
          ...
          <motion.h3 variants={moveUp(0.4)} initial="hidden" whileInView="show" viewport={{amount: 0.1, once: true}} className="text-[1.3rem] md:text-md xl:text-lg 2xl:text-xl font-light text-black leading-[1.18]  pt-4 md:pt-6 2xl:pt-10 mb-4  xl:mb-5 2xl:mb-5">
            Elementary School Education During COVID-19
          </motion.h3>
          <motion.p variants={moveUp(0.6)} initial="hidden" whileInView="show" viewport={{amount: 0.1, once: true}} className="text-colorpara text-sm font-light">
          ...
          <motion.h3 variants={moveUp(0.8)} initial="hidden" whileInView="show" viewport={{amount: 0.1, once: true}} className="text-[1.3rem] md:text-md xl:text-lg 2xl:text-xl font-light text-black leading-[1.18]  pt-4 md:pt-6 2xl:pt-10 mb-4  xl:mb-5 2xl:mb-5">
            Elementary School Education Post COVID-19
          </motion.h3>
          <motion.p variants={moveUp(1)} initial="hidden" whileInView="show" viewport={{amount: 0.1, once: true}} className="text-colorpara text-sm font-light">
          ...
          <motion.h3 variants={moveUp(1.2)} initial="hidden" whileInView="show" viewport={{amount: 0.1, once: true}} className="text-[1.3rem] md:text-md xl:text-lg 2xl:text-xl font-light text-black leading-[1.18]  pt-4 md:pt-6 2xl:pt-10 mb-4  xl:mb-5 2xl:mb-5">
            Challenges Faced By Elementary Students in Classroom  
          </motion.h3>
          <div className=" mb-4 md:mb-6 xl:mb-7 ">
            <ul className="list-disc pl-5 pb-3">
              <motion.li variants={moveUp(1.4)} initial="hidden" whileInView="show" viewport={{amount: 0.1, once: true}} className="text-sm font-medium text-black">
                Emotional and Social Development
              </motion.li>
            </ul>
            <motion.p variants={moveUp(1.6)} initial="hidden" whileInView="show" viewport={{amount: 0.1, once: true}} className="text-colorpara text-sm font-light">
          ...
          <div className=" mb-4 md:mb-6 xl:mb-7 ">
            <ul className="list-disc pl-5 pb-3">
              <motion.li variants={moveUp(1.8)} initial="hidden" whileInView="show" viewport={{amount: 0.1, once: true}} className="text-sm font-medium text-black">
                Dependence on Technology
              </motion.li>
            </ul>
            <motion.p variants={moveUp(2)} initial="hidden" whileInView="show" viewport={{amount: 0.1, once: true}} className="text-colorpara text-sm font-light">
          ...
          <div >
            <ul className="list-disc pl-5 pb-3">
              <motion.li variants={moveUp(2.2)} initial="hidden" whileInView="show" viewport={{amount: 0.1, once: true}} className="text-sm font-medium text-black">
                Prioritize Mental Health And Well-Being
              </motion.li>
            </ul>
            <motion.p variants={moveUp(2.4)} initial="hidden" whileInView="show" viewport={{amount: 0.1, once: true}} className="text-colorpara text-sm font-light">
