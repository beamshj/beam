    ...
    <section className="pt-8 md:pt-12 lg:pt-20 2xl:pt-[135px] pb-4 md:pb-5 lg:pb-10 2xl:pb-[40px] overflow-hidden ">
      <div className="container">
        <div>
          <div>
            <h2
              className="text-lg lettersp-4 lg:text-xl xl:text-2xl 2xl:text-4xl  font-light leading-[1.111111111] text-black mb-4 md:mb-6 xl:mb-8 2xl:mb-8"
        ...
        {commentsData.items.map((item, index) => (
          <SwiperSlide key={index} className="flex items-stretch">
            ...
            >
              ...
              {/* 👤 Profile */}
              <div className="flex gap-2 md:w-[80%] border-t border-black pt-5 mt-8">
                <Image
                  src={item.icon}
                  alt={item.name}
                  width={90}
