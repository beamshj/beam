  ...
  return (
    <section className="py-8 md:py-12 lg:py-20 2xl:py-[135px] relative " style={{backgroundImage: `url(${criteriaData.image})`, backgroundSize: "cover", backgroundPosition: "center"}}>
      ...
      <div className="container relative z-10">
        <div> 
          <div>
            <h2 className="text-xl xl:text-2xl 2xl:text-4xl  font-light leading-[1.111111111] text-white mb-4 md:mb-6 xl:mb-8 2xl:mb-13">
              {criteriaData.title}
            </h2> 
              <p className=" text-sm lg:text-md xl:text-lg leading-[1.526315789473684] max-w-[55ch] mb-4 lg:mb-7   font-light  text-white">{criteriaData.description}</p>
