  ...
  return (
    <section className="w-full h-full relative">
        ...
        <div className="container h-full z-30 relative">
            <div className="relative z-20 flex justify-center h-full text-white flex-col w-[75%] gap-10 py-[160px]">
                <div className='flex flex-col gap-7'>
                <h2 className='text-4xl'>Join the Beam Family</h2>
                <p className='text-xl'>Join Beam's dynamic team where innovation meets passion. Grow your career, make an impact, and help shape tomorrow.</p>
                </div>
