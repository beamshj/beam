          ...
          {displayItems.map((item, idx) => (
            ...
            >
              <Link href={`/news-&-media/blog/blog-details/${item.slug}`}>
                {/* Main Image */}
                <Image src={item.thumbnail || "/images/fallback.jpg"} alt={item.thumbnailAlt} fill sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 40vw"
                  priority fetchPriority="high" className="object-cover" />
