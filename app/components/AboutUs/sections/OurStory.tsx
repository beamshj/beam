  ...
  return (
    <section className="pt-10 xl:pt-20 2xl:pt-[135px]">
      <div className="container">
        <div className="mb-3 md:mb-6 xl:mb-8 2xl:mb-12">
          <h2 className="text-lg md:text-xl xl:text-2xl 2xl:text-4xl font-light leading-[1.111111111] text-black">
            <SplitText
              tag="span"
              text={t.mainTitle}
              className=""
        ...
        <div className="relative rounded-[12px] overflow-hidden">
          <Image src={t.image} alt={t.imageAlt} width={1518} height={605} sizes="100vw" loading="lazy" className="w-full h-50 md:h-[300px] lg:h-[455px] xl:h-[500px] 2xl:h-[605px] object-cover" ref={imageRef} />
          {/* Gradient overlay */}
          ...
          2xl:left-[60px] 2xl:bottom-[50px] text-white text-[24px] sm:text-md md:text-lg  xl:max--w-0 xl:text-2xl 2xl:text-4xl font-light lettersp-4 leading-[1.111111111] ${isArabic ? "max-w-6xl" : "max-w-[20ch]"}`} >
        ...
        <div className="mt-[30px] xl:mt-[40px] 2xl:mt-[50px] text-sm text-colorpara font-light leading-[1.526315789473684]">
          {t.description.split("\n\n").map((para, idx) => (
            <p key={idx}>
              ...
              {para.split("\n").map((line, i) => (
                <motion.span
                  variants={moveUp(i * 0.1)}
                  initial="hidden"
                  whileInView="show"
                  viewport={{ once: true, amount: 0.2 }}
                  key={i}
                  className="text-colorpara block mb-[14px] xl:mb-6 last:mb-0"
                >
                  {" "}
                  {/* line spacing */}
                  {line}
