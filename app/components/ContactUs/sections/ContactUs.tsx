...
const ContactForm: React.FC<{ data: FirstSection }> = ({ data }) => {
  ...
  return (
    <section className="container py-12 lg:py-15 xl:py-[135px]">
      <div className="flex flex-col lg:flex-row gap-5 lg:gap-10 xl:gap-20 2xl:gap-[103px] lg:items-center">
        ...
        >
          <div className="flex flex-col sm:flex-row sm:gap-10 lg:gap-[54px]">
            <motion.div
              variants={moveUp(0.2)}
              initial="hidden"
              whileInView="show"
          ...
          <div className="flex flex-col sm:flex-row sm:gap-10 lg:gap-[54px]">
            ...
            >
              <input
                type="email"
                placeholder={
                  isArabic ? "البريد الالكتروني" : "Enter Your Email ID"
                }
                {...register("email")}
                className="w-full border-b text-colorpara border-colorpara py-2 xl:py-[23px] focus:outline-none placeholder:text-colorpara text-sm font-light placeholder:py-2"
              />
            ...
            >
              <input
                type="text"
                placeholder={
                  isArabic ? "رقم الجوال" : "Enter Your Phone Number"
                }
                {...register("phone")}
                onInput={(e) => {
