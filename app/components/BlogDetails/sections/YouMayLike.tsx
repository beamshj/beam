       ...
       {rsData.map((item, index) => (
          <div key={index}>
            <div className="relative">
              <Image src={item.thumbnail} alt="" width={486} height={301} className="rounded-t-lg img-fluid object-cover w-full h-full" />
            ...
            <div className="p-5 md:p-6 xl:p-10 border-1 border-[#D3D3D3]  rounded-b-lg">
              ...
              <div className="mt-3">
              <p className="text-[1.3rem] md:text-md xl:text-lg 2xl:text-xl font-light text-black leading-[1.18] lettersp-1 overflow-hidden text-ellipsis line-clamp-2 display[-webkit-box] [-webkit-line-clamp:2] [-webkit-box-orient:vertical]">{item.title}</p>
              </div>
