                  ...
                  <div className="h-full relative w-full overflow-hidden">
                    ...
                    >
                      ...
                      <motion.div
                        ...
                        className="xl:mb-[65px] col-span-1 md:col-span-5"
                      >
                        <motion.h2
                          initial={{ opacity: 0, y: 40 }}
                          animate={{ opacity: 1, y: 0 }}
                      ...
                      <motion.div
                        ...
                        className="md:mb-[35px] lg:mb-[85px] xl:mb-[120px] flex justify-end flex-col xl:items-end col-span-1 md:col-span-2"
                      >
                        <div>
