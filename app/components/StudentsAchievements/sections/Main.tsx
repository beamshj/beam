      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 md:items-stretch gap-x-6 gap-y-6 md:gap-y-0 md:gap-x-10 xl:gap-x-18">
          <div className="flex flex-col">
            ...
            <motion.p variants={moveUp(0.5)} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} className="text-colorpara text-sm leading-[1.526315789473684] mb-[30px]">{t.intro}</motion.p>
            <motion.h3 variants={moveUp(0.6)} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} className="text-md font-seimibold mb-4 xl:mb-6">{t.secondIntro}</motion.h3>
            <div
  className="students-achievemnets-content-html text-colorpara"
