              ...
              >
                ...
                <div className="flex flex-col h-full justify-between relative z-30">
                  ...
                  <div className="flex flex-col justify-end relative overflow-hidden min-h-[4rem]">
                    <div className="group-hover:opacity-0 group-hover:-translate-y-full transition-all duration-300">
                      <h3 className="text-lg font-light leading-[1.2] text-black mb-3">{item.title}</h3>
                    </div>
                    <div className="absolute bottom-0 left-0 w-full opacity-0 group-hover:opacity-100 translate-y-full group-hover:translate-y-0 transition-all duration-300">
