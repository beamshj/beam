export const academicCulturalData = {
   ...
   accvalues: [
      {
         id: 1,
         img: '/images/home/gem1.svg', 
         imgwidth: 60,
         imgheight: 75,
         title: 'Integrating Arabic & Islamic values in global education', 

      }, 
      {
         id: 2,
         img: '/images/home/gem2.svg', 
         imgwidth: 87,
         imgheight: 75,
      ...
      {
         id: 3,
         img: '/images/home/gem3.svg', 
         imgwidth: 75,
         imgheight: 75,
         title: 'Dual language proficiency', 
