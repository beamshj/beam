                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-col gap-2">
                          <div className="flex flex-col gap-2">
                            ...
                            />
                            {errors.secondSection?.items?.[index]?.logoAlt && (
                              <p className="text-red-500">
                                {
                                  errors.secondSection?.items?.[index]?.logoAlt
                                    .message
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex flex-col gap-2">
                        <div className="flex flex-col gap-2">
                          ...
                          />
                          {errors.historySection?.items?.[index]?.imageAlt && (
                            <p className="text-red-500">
                              {
                                errors.historySection?.items?.[index]?.imageAlt
                                  .message
                      ...
                      <div className="flex flex-col gap-2">
                        <div className="flex flex-col gap-2">
                          ...
                          <Input
                            type="text"
                            placeholder="Year"
                            {...register(`historySection.items.${index}.year`, {
                              required: "Value is required",
                            })}
                          />
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex flex-col gap-2">
                      ...
                      {errors.seventhSection?.items?.[index]?.image && (
                        <p className="text-red-500">
                          {errors.seventhSection?.items?.[index]?.image.message}
                        </p>
                      )}
                    </div>
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex flex-col gap-2">
                        <div className="flex flex-col gap-2">
                          <div className="flex flex-col gap-2">
                            ...
                            />
                            {errors.secondSection?.items?.[index]?.title_ar && (
                              <p className="text-red-500">
                                {
                                  errors.secondSection?.items?.[index]?.title_ar
                                    .message
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex flex-col gap-2">
                        <div className="flex flex-col gap-2">
                          ...
                          />
                          {errors.historySection?.items?.[index]?.title_ar && (
                            <p className="text-red-500">
                              {
                                errors.historySection?.items?.[index]?.title_ar
                                  .message
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <Input
                        type="text"
                        placeholder="Alt Tag"
                        {...register(`sixthSection.items.${index}.imageAlt_ar`)}
                      />
                    </div>
                  </div>
