          ...
          <div  >
            ...
            <div  >
              ...
              ${index === academicCulturalData.accvalues.length - 2 ? 'ps-0 xl:ps-[8%] 2xl:ps-[15%]' : ''} ${index === academicCulturalData.accvalues.length - 1 ? 'ps-0 xl:ps-[18%] 2xl:ps-[30%]' : ''}`} key={index}>
                  ...
                  <div>
                    <p className={`text-xl font-light text-black leading-[1.2] lettersp-1 ${index === academicCulturalData.accvalues.length - 1 ? 'max-w-[15ch]' : 'max-w-[18ch]'}   transition-all duration-300`}>
                      {value.title}
                    </p>
                  </div>
                </div>
