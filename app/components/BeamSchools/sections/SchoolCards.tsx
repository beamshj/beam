    ...
    <section className="py-10 xl:py-20 2xl:py-[135px]">
      <div className="container">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-5 lg:mb-10 xl:mb-[65px] pb-5 xl:pb-[30px] border-b border-bdrcolor">
          {/* Left Buttons (Curriculum Filter) */}
          ...
          <div className="relative w-full md:w-fit" ref={dropdownRef}>
            <motion.button
              ...
              className="w-full cursor-pointer md:w-fit flex items-center px-2 md:px-4 xl:px-[20px] py-2 md:py-2 xl:py-[10px] border border-[#12586C] bg-[#C9F3FF] rounded-[50px] text-[#626262] text-xs md:text-sm font-light min-w-[180px] justify-between"
            >
              <span>{selectedLocation}</span>
              <ChevronDown
                className={`lg:w-[28px] lg:h-[28px] transition-transform font-light text-[#42BADC] ${
            ...
            {isDropdownOpen && (
              <div className="absolute top-full mt-1 right-0 bg-white border border-gray-200 rounded-[12px] shadow-lg min-w-full lg:min-w-[180px] z-50 overflow-hidden">
          ...
          {filteredCampuses.map((campus, index) => (
            ...
            >
              <Link href={campus.link} target="_blank">
                ...
                ${
                  hoveredCard === campus._id || activeCard === campus._id
