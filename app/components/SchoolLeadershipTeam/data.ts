...
export const focusData = {
  ...
  videos: ["/video/video.mp4","/video/video.mp4","/video/video.mp4"],
};
...
export const commentsData = {
  ...
  description: 'At BEAM’s Creative Science Schools, parent and student satisfaction is paramount, as their feedback is a measure of our commitment to delivering on our Mission, Vision, and Ethos.',  
  items:[
    { 
      details:["The International School of Creative Science was my first choice when it came to choosing a bespoke school for my daughter. It enriches in our children the great values of Islam alongside high-quality education in both English and Arabic equally.",
    ...
    { 
      details:["The reason I like my school is that we are involved in many activities such as Student Council, projects, experiments, and many more. The activities are so much fun, and they help us learn in a fun and easier way.",
        "The second reason why I like my school is the teachers educate us in an easier way and which we understand; for example, they use WAGOLLS, they plan activities that show us easy techniques on how to solve a problem and then give us application tasks to challenge ourselves. My last reason is how the school takes care of our well-being through well-being lessons, and teachers "
      ],
      icon:"/images/testimonials/user.png",
      name:"Rafia Bin Byat",
      designation:"Parent, ISCS Muwaileh"
