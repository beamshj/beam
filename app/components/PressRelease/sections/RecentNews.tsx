      ...
      <div className="container">
        <div className="flex flex-col md:flex-row justify-between w-full md:items-center pb-4 md:pb-6 xl:pb-8 2xl:pb-12 mb-4 md:mb-6 xl:mb-8 2xl:mb-16 border-b border-bdrcolor gap-5 lg:gap-0">
          ...
          <div className="flex gap-3 items-center">
            {RecentNewsData.category.map((item, index) => (
              <motion.div variants={moveUp(index * 0.2)} initial="hidden" whileInView="show" viewport={{amount: 0.1, once: true}} key={index} className={`p-[1px] group transition-color group  rounded-full hover:bg-[linear-gradient(90deg,_#42BADC_0%,_#12586C_100%)]
        ...
        <div className="lg:flex gap-12">
          <div className="lg:w-3/5">
            <motion.div variants={moveUp(0.2)} initial="hidden" whileInView="show" viewport={{amount: 0.1, once: true}} className="pb-4 md:pb-6 xl:pb-8 2xl:pb-12 text-colorpara text-sm font-light"> <p>{RecentNewsData.description}</p></motion.div>
            <Newslist data={RecentNewsData} />
          </div>
          <div className="lg:w-2/5">
            <motion.div variants={moveUp(0.2)} initial="hidden" whileInView="show" viewport={{amount: 0.1, once: true}} className="p-4 md:p-6 xl:p-10 bg-[#F6F6F6] rounded-xl mb-5 md:mb-7 mt-5 lg:mt-0">
