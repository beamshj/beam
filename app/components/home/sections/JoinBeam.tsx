...
const JoinBeam = () => {
  return (
    <motion.section className="w-full h-full relative"
    variants={fadeUp}
                            initial="hidden"
                            whileInView="visible"
        ...
        <div className="container h-full z-30 relative">
            <div className="relative z-20 flex justify-center h-full text-white flex-col w-full md:w-[75%] gap-10 pt-20 pb-25 md:py-[160px]">
                ...
                <motion.h2 className='text-4xl font-light lettersp-4' variants={fadeInLeft}
                                                initial="hidden"
                                                whileInView="visible"
                                                viewport={{ once: true, amount: 0.2 }}>Join the Beam Family</motion.h2>
               <motion.div  variants={fadeUp}
                ...
                <motion.div 
                 variants={fadeUp}
                  ...
                  whileInView="visible"
                  viewport={{ once: true, amount: 0.2 }}
                  transition={{ delay: 0.4, duration: 0.2, ease: 'easeOut' }}className='mt-5 w-fit md:mt-10 p-[1px] group transition-all duration-300 border-[1px] border-primary rounded-full hover:translate-x-[5px] hover:shadow-[0_0_15px_rgba(66,186,220,0.5)]'>
