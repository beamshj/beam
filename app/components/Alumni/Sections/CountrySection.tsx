...
<div
    className="
        relative w-full 2xl:w-[485px] h-[590px]
        rounded-[12px] border border-[#D3D3D3]
        overflow-hidden
        bg-[linear-gradient(180deg,#FFFFFF_0%,#E2F5FF_100%)]
    "
>
    ...
    <div className="relative z-10 h-full p-6 2xl:p-10 flex flex-col">
        <div className="flex items-center gap-5">
            <div className="w-[70px] h-[50px] rounded-[12px] overflow-hidden">
                <Image src={item.flag} alt={item.name} width={70} height={50} className="w-full h-full object-cover" />
            </div>
            <span className="text-black font-light text-lg 2xl:text-xl">{item.name}</span>
        </div>

        {item.universities && (
            <div>
                <div className="h-px w-full bg-[#626262] my-[25px] 2xl:my-[35px]" />
                <div
