    ...
    <section className="py-8 md:py-12 lg:py-20 2xl:py-[135px]">
      <div className="container">
        <div className="grid lg:grid-cols-[57%_40%] gap-[3%] ">
          ...
          <div >
          <div>
          <h2 className="text-2xl 2xl:text-4xl max-w-[50ch] font-light leading-[1.111111111] text-black mb-4 md:mb-6 xl:mb-8 2xl:mb-12">
              {fsData.title}
            </h2>
            ...
            {fsData.items.map((item,index)=>{
              return(
                ...
                <div key={index} className="flex  items-center gap-3 pt-7 pb-5 group cursor-pointer">
                  ...
                  <p className="text-[1.3rem] md:text-md xl:text-lg 2xl:text-xl font-light   leading-[1.2] group-hover:text-primary transition-colors duration-300">{item.title}</p>  
                </div>
                </div>
              )
            })}
          ...
          {/* Right Image */}
          <div className="relative w-full h-[250px] lg:h-auto rounded-[12px] overflow-hidden lg:ms-10" >
