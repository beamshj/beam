                        ...
                        <div className='flex flex-col gap-2'>
                            ...
                            <div>
                                ...
                                <div className='flex justify-end mt-2'>
                                    <Button type='button' addItem onClick={() => secondSectionAppend({ title: "",title_ar:"" })}>Add Item</Button>
                                </div>
                            </div>
                    ...
                    <div className='p-5 rounded-md flex flex-col gap-2'>
                        <div className='flex flex-col gap-2'>
                            ...
                            <div>
                                ...
                                <div className='flex justify-end mt-2'>
                                    <Button type='button' addItem onClick={() => thirdSectionAppend({ title: "",title_ar: "", image: "", imageAlt: "",imageAlt_ar: "", description_ar: "", description: "" })}>Add Item</Button>
                                </div>
                            </div>
                    ...
                    <div className='p-5 rounded-md flex flex-col gap-2'>
                        <div className='flex flex-col gap-2'>
                            ...
                            <div>
                                ...
                                <div className='flex justify-end mt-2'>
                                    <Button type='button' addItem onClick={() => secondSectionAppend({ title_ar: "",title:"" })}>Add Item</Button>
                                </div>
                            </div>
                ...
                <AdminItemContainer>
                    ...
                    <div className='p-5 rounded-md flex flex-col gap-2'>
                        <div className='flex flex-col gap-2'>
                            <div className='flex flex-col gap-1'>
                                <Label className='font-bold'>Main Title</Label>
                                <Input type='text' placeholder='Main Title' {...register("thirdSection.mainTitle_ar")} />
                            </div>
                            <div className='flex flex-col gap-1'>
                                <Label className='font-bold'>First Description</Label>
                                <Textarea placeholder='First Description' {...register("thirdSection.firstDescription_ar")} />
                            </div>
                            <div className='flex flex-col gap-1'>
                                <Label className='font-bold'>Sub Title</Label>
                            ...
                            <div className='flex flex-col gap-1'>
                                <Label className='font-bold'>Second Description</Label>
                                <Textarea placeholder='Second Description' {...register("thirdSection.secondDescription_ar")} />
                            </div>
                            <div>
                                <Label className='font-bold'>Items</Label>
                                <div className='border p-2 rounded-md grid grid-cols-2 gap-5'>
                                        ...
                                        <div key={field.id} className='grid grid-cols-1 gap-2 relative border-r pr-5 last:border-r-0'>
                                            ...
                                            <div className='flex flex-col gap-2'>
                                                <div className='flex flex-col gap-2'>
                                                    ...
                                                    <div className='flex flex-col gap-2'>
                                                        <Label className='font-bold'>Description</Label>
                                                        <Textarea placeholder='Description' {...register(`thirdSection.items.${index}.description_ar`)} />
                                                    </div>
                                                    <div className='flex flex-col gap-2'>
                                                        <div className='flex flex-col gap-2'>
                                                            <Label className='font-bold'>Image</Label>
                                ...
                                <div className='flex justify-end mt-2'>
                                    <Button type='button' addItem onClick={() => thirdSectionAppend({ title: "",title_ar:"", image: "", imageAlt: "",imageAlt_ar: "", description: "", description_ar: "" })}>Add Item</Button>
                                </div>
                            </div>
                        ...
                        <div className='flex flex-col gap-2'>
                            ...
                            <div className='grid grid-cols-2 gap-2'>
                                ...
                                <div>
                                    ...
                                    <div className='flex flex-col gap-1'>
                                        <Label className='font-bold'>Email</Label>
                                        <Input type='text' placeholder='Email' {...register("fourthSection.email_ar")} />
                                    </div>

                                    <div className='flex flex-col gap-1'>
                                        <Label className='font-bold'>Button Text</Label>
                                        <Input type='text' placeholder='Button Text' {...register("fourthSection.buttonText_ar")} />
                                    </div>
