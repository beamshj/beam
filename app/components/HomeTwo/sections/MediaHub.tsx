                ...
                return (
                  <SwiperSlide key={index}>
                    <motion.div
                      ...
                      className={`h-[350px] lg:h-[450px] xl:h-[557px] rounded-[15px] group slidegpmn cursor-pointer relative overflow-hidden ${
                    ...
                    >
                      ...
                      <div className="h-full rounded-[15px] transition-all duration-300 hdriv relative z-10 overflow-hidden">
                        <div className="p-10">
                          ...
                          <p
                            className={`text-white line-clamp-2 xl:line-clamp-3 text-lg lg:text-xl font-light leading-[1.2] mt-6 transform transition-all duration-500 delay-300 ${isActiveOnMobile ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-4 lg:group-hover:opacity-100 lg:group-hover:translate-x-0"}`}
                          >
                            {value.title}
                          </p>
