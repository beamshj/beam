    ...
    () => [
      {
        ...
        to: { y: "0%", x: 0 },
        clipPath:
          "polygon(0 0, 100% 0, 100% 100%, 80% 100%, 80% 92%, 60% 92%, 60% 100%, 40% 100%, 40% 92%, 20% 92%, 20% 100%, 0 100%)",
        movement: { y: -20, x: 0 },
      },
      {
        from: { y: 0, x: "100%" },
        to: { y: 0, x: "0%" },
        clipPath:
          "polygon(0 0, 100% 0, 100% 100%, 0 100%, 0 80%, 8% 80%, 8% 60%, 0 60%, 0 40%, 8% 40%, 8% 20%, 0 20%)",
        movement: { y: 0, x: 20 },
      },
      {
        from: { y: "100%", x: 0 },
        to: { y: "0%", x: 0 },
        clipPath:
          "polygon(0 0, 20% 0, 20% 8%, 40% 8%, 40% 0, 60% 0, 60% 8%, 80% 8%, 80% 0, 100% 0, 100% 100%, 0 100%)",
        movement: { y: 20, x: 0 },
      },
      {
        from: { y: 0, x: "-100%" },
        to: { y: 0, x: "0%" },
        clipPath:
          "polygon(0 0, 100% 0, 100% 20%, 92% 20%, 92% 40%, 100% 40%, 100% 60%, 92% 60%, 92% 80%, 100% 80%, 100% 100%, 0 100%)",
        movement: { y: 0, x: -20 },
      },
    ],
    [],
