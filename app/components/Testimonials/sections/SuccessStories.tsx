                ...
                {focusData.videos.map((video, index) => {
                  ...
                  return (
                    <SwiperSlide key={index} className="flex items-stretch">
                      <motion.div variants={moveUp(index * 0.2)} initial="hidden" whileInView="show" viewport={{amount: 0.1, once: true}} className="relative w-full h-[250px] md:h-[420px] rounded-[12px] overflow-hidden flex-grow">
                        {/* Background image */}
        ...
        <div className="pt-8 md:pt-12 lg:pt-20 2xl:pt-[135px]">
          <div className="pt-5 lg:pt-7 border-t border-[#D3D3D3]">
            <div className=" flex gap-3 z-10">
              <button className="swiper-button-prev-story transition cursor-pointer group" aria-label="Previous">
                <Image src="/images/icons/arrow-right.svg" alt="Prev" width={18} height={18} className="group-hover:scale-140 transition-all duration-300 brightness-44 opacity-25 group-hover:opacity-100 group-hover:brightness-100" />
              </button>
              <button className="swiper-button-next-story transition cursor-pointer group" aria-label="Next">
                <Image src="/images/icons/arrow-right.svg" alt="Next" width={18} height={18} className="rotate-180 group-hover:scale-140 transition-all duration-300 brightness-44 opacity-25 group-hover:opacity-100 group-hover:brightness-100" />
              </button>
            </div>
          </div>
        </div>
