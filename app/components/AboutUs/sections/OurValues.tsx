...
//                  isArabic ? "px-10" : "px-4"
//                } pt-4 pb-5 values-description-about max-h-[75%] overflow-y-auto 3xl:overflow-y-hidden`}
...
export default function ValuesGrid({ data }: Props) {
  ...
  return (
              ...
              >
                ...
                <div className="absolute inset-0 overflow-hidden rounded-[12px]">
                  <Image
                    ...
                    alt={item.imageAlt}
                    fill
                    className={`object-cover w-full transition-all duration-400 group-hover:scale-105 ${
                      hovered === index
                        ? "brightness-100"
                        : "brightness-75 grayscale"
                    }`}
    ...
    ${isArabic ? "px-10" : "px-4"} pt-4`}
        ...
        max-h-[300px] lg:max-h-[322px] xl:max-h-[393px] 2xl:max-h-[510px]
        [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]
        values-description-about pb-8"
