    ...
    return (
        <section className="relative w-full  2 bg-[#F6F6F6] aftergd">
            ...
            <div className=' py-8  md:py-15 xl:py-[142px]'>  
                        <div className='flex flex-col gap-4 lg:gap-12  justify-center'>
                            <div className='border-b border-[#D3D3D3] pb-5 hidden lg:block w-[80%] lg:w-[75%]'>
                            <h2 className='text-xl'>{messageSectionData.heading}</h2>
                            </div>
                            <div>
                            <h1 className='text-4xl text-black  font-light max-w-[12ch]'>{messageSectionData.title}</h1>
                            </div>
                            <div className='text-sm flex flex-col gap-6 pe-4 xl:pe-[92px] '>
            ...
            <div className='relative z-10 hidden lg:block'>
                ...
                <Image src={messageSectionData.image} alt="Message" width={702} height={964} className=''/>
                
                </div>
                <div className='w-fit ml-[50px] 2xl:ml-auto h-full justify-center flex flex-col gap-1     bottom-[26%] 2xl:bottom-[8%] z-10 relative'>
